...
from bot import bot, app, dispatcher, updater, botStartTime, DOWNLOAD_DIR, IGNORE_PENDING_REQUESTS, IS_VPS, PORT, alive, web, nox, OWNER_ID, AUTHORIZED_CHATS, LOGGER, AUTO_TG_DOWN
...
def start(update, context):
    ...
    buttons.buildbutton("Repo", "https://github.com/jhashubham7905/gdtot-torrent-mirror-leech/")
    buttons.buildbutton("Owner", "https://t.me/honey66")
